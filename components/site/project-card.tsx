...
// All cards now share a clean white background for consistency.
const CATEGORY_ACCENTS: Record<ProjectCategory, string> = {
  "Health": "#4DC8E8",
  "Nutrition": "#2ECC8A",
  "Social Affairs": "#4DC8E8",
  "Management": "#8B5CF6",
  "Capacity Building": "#F59E0B",
}
...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <article
      className="group relative flex h-full flex-col rounded-2xl p-7 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden border-2 border-border bg-white"
    >
